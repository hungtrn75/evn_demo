class AppUrl {
  ...
  static const String vectorTileUrl = "https://vntilesgl.eofactory.ai/styles/demo/style.json";
  ...
  static const String directionUrl = "https://api.mapbox.com/directions/v5/mapbox/driving-traffic/{waypoints}?alternatives=false&geometries=geojson&language=vi&overview=full&steps=true&access_token=${const String.fromEnvironment("ACCESS_TOKEN")}";
  // https://api-gtvtqs.eofactory.ai/api/autocomplete?search=c%C3%A1t&limit=5
  static const String geocodeUrl = "https://api-gtvtqs.eofactory.ai/api/autocomplete";
  //https://api-gtvtqs.eofactory.ai/api/reversegeocoding?lat=21.022188167867625&lng=105.8233922656733
  static const String reverseGeocodeUrl = "https://api-gtvtqs.eofactory.ai/api/reversegeocoding";
}
